...
public static partial class ResultComposition
{
    extension<T, TNext>(ValueTask<Result<T>>)
    {
        ...
        public static ValueTask<Result<TNext>> operator |(ValueTask<Result<T>> self, Func<T, Result<TNext>> next)
            => self.Then(WrapAsync(next));

        public static ValueTask<Result<TNext>> operator |(ValueTask<Result<T>> self, Func<T, TNext> next)
            => self.Then(WrapAsync(next));
    }
    ...
    extension<T>(ValueTask<Result<T>>)
    {
        ...
        public static ValueTask<Result<T>> operator |(ValueTask<Result<T>> self, Func<T, Result<None>> next)
            => self.Then(WrapAsync(next));
    ...
    extension<T, TNext>(Task<Result<T>>)
    {
        ...
        public static ValueTask<Result<TNext>> operator |(Task<Result<T>> self, Func<T, Result<TNext>> next)
            => self.Then(WrapAsync(next));

        public static ValueTask<Result<TNext>> operator |(Task<Result<T>> self, Func<T, TNext> next)
            => self.Then(WrapAsync(next));
    }
    ...
    extension<T>(Task<Result<T>>)
    {
        ...
        public static ValueTask<Result<T>> operator |(Task<Result<T>> self, Func<T, Result<None>> next)
            => self.Then(WrapAsync(next));
